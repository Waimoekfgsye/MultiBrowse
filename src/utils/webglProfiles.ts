export interface WebGLProfileBundle {
  vendor: string;
  renderer: string;
  webGlSupportedExtensions: string[];
  webGl2SupportedExtensions: string[];
  webGlContextAttributes: Record<string, any>;
  webGl2ContextAttributes: Record<string, any>;
  webGlParameters: Record<string, any>;
  webGl2Parameters: Record<string, any>;
  webGlShaderPrecisionFormats: Record<string, any>;
  webGl2ShaderPrecisionFormats: Record<string, any>;
}
...
function makeBundle(vendor: string, renderer: string, params: Record<string, any>): WebGLProfileBundle {
  return {
    vendor,
    renderer,
...
export function getWebGLBundle(vendor: string, renderer: string): WebGLProfileBundle {
...
export const EXAMPLE_RTX_4090_BUNDLE = makeBundle(
  'Google Inc. (NVIDIA)',
